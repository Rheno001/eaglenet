                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className="bg-gray-900 rounded-3xl p-12 lg:p-16">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <Link
                                to="/contact"
                                className="bg-transparent text-white border-2 border-white px-8 py-4 rounded-xl hover:bg-white hover:text-gray-900 transition-all font-semibold text-lg inline-block"
                            >
                                Contact Sales
                            </Link>
                        </div>
