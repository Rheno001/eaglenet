    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <header className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
        <div>
          ...
          <p className="text-slate-500 font-medium mt-1">Review your logistics settlement history and invoices.</p>
        </div>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-100">
                  ...
                  <th className="px-8 py-6 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest">Manifest</th>
           ...
           <div className="bg-white rounded-[3rem] w-full max-w-5xl overflow-hidden shadow-2xl relative animate-in zoom-in-95 duration-300">
              ...
              <div className="p-8 bg-slate-900 text-white flex items-center justify-between">
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                       <h3 className="text-xl font-black uppercase tracking-tight leading-none mb-1">Receipt Intelligence</h3>
              ...
              <div className="p-10 space-y-10">
                 ...
                 <div className="grid grid-cols-2 gap-10">
                    ...
                    <div className="space-y-6">
                       <div>
                          <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Shipment Target</p>
