...
export default function AdminPayments() {
  ...
  const fetchPayments = async () => {
    try {
      const res = await fetch("https://eaglenet-eb9x.onrender.com/get-all-payments.php");
  ...
  const exportPayments = (type) => {
    window.open(`https://eaglenet-eb9x.onrender.com/export-payments.php?type=${type}`, "_blank");
  };
