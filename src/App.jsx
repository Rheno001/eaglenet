        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-gray-900">EagleNet-Logistics</span>
            </div>
      ...
      <footer className="bg-gray-900 text-white py-16 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">EagleNet</span>
              </div>
            ...
            {[
              ...
              {
                title: 'Services',
                links: ['Freight Forwarding', 'Warehousing', 'Express Delivery', 'Customs']
              },
              {
                title: 'Support',
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} EagleNet Logistic Services. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
